...
class IndexController extends BasicController {
	public function indexAction(){
        $m = Helper::M('Nav');
        $list = $m->getNavByGroup($this->uinfo['user_group'] , $this->uinfo['agent_level']);
