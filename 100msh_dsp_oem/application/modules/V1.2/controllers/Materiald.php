  ...
  */
    ...
    */
    ...
    public function addtargetAction(){
        ...
        $data['city_info'] =  Helper::clean($this->getRequest()->getPost('city_info'));//定向内容
        $data['targeting_level'] =  Helper::clean($this->getRequest()->getPost('targeting_level'));//定向级别
        $data['access_token'] = $access_token;
